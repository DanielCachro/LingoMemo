...
export default function MainNavigation() {
	return (
		<div className='sm: shrink-0 border-background-200 px-32 py-16 sm:h-dvh sm:w-192 sm:space-y-48 sm:border-r-2 sm:p-0 sm:pt-64 sm:pl-24 dark:border-background-800'>
